...
录制检查页可以依次添加“等待条件”和“断言”，也可以从用例详情的 Web“查看 / 编辑”修改已有 YAML，无需重新录制。等待步骤默认最多 60 秒，支持 1–300 秒；条件提前满足立即继续。AI 断言仍只检查当时页面，不会因为描述里写了“等十秒”而延迟执行。
...
```yaml
      ...
      - aiWaitFor:
          ...
          timeoutMs: 120000
      - aiAssert: 最新用户消息下方有非空回答，并且没有请求失败提示
```
